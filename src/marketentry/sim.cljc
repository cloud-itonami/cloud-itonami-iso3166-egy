...
(defn -main [& _]
  (let [db (store/seed-db)
        actor (op/build db)]
    (println "== engagement/intake eng-1 (EGY, clean) ==")
    ...
    (println "== jurisdiction/assess eng-4 (sets up eg-entity-missing) ==")
    ...
    (println "== filing/submit eng-4 (eg-entity-missing -> HARD hold) ==")

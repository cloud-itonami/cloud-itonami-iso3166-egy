(ns marketentry.store
  "SSoT for the EGY market-entry compliance actor, behind a `Store`
...
(defn demo-data
  ...
  []
  {:engagements
   {"eng-1" {:id "eng-1" :operator "Kita Systems EG" :portal "e-Tenders"
             :base-fee 500000 :monthly-rate 30000 :monitoring-months 12
             :claimed-fee 860000.0
             :requires-eg-entity? true :has-eg-entity? true
             :requires-cr? true :cr-verified? true
             :drafted? false :submitted? false
             :jurisdiction "EGY" :status :intake}
    "eng-2" {:id "eng-2" :operator "Atlantis LLC" :portal "e-Tenders"
             :base-fee 500000 :monthly-rate 30000 :monitoring-months 12
             :claimed-fee 860000.0
             :requires-eg-entity? true :has-eg-entity? true
             :requires-cr? true :cr-verified? true
    ...
    "eng-3" {:id "eng-3" :operator "Minami Systems" :portal "e-Tenders"
             :base-fee 500000 :monthly-rate 30000 :monitoring-months 12
             ...
             :drafted? false :submitted? false
             :jurisdiction "EGY" :status :intake}
    "eng-4" {:id "eng-4" :operator "Higashi Export" :portal "e-Tenders"
             :base-fee 500000 :monthly-rate 30000 :monitoring-months 12
             :claimed-fee 860000.0
             :requires-eg-entity? true :has-eg-entity? false
             :requires-cr? true :cr-verified? true
             :drafted? false :submitted? false
             :jurisdiction "EGY" :status :intake}
    "eng-5" {:id "eng-5" :operator "Nishi Logistics" :portal "e-Tenders"
             :base-fee 500000 :monthly-rate 30000 :monitoring-months 12
             :claimed-fee 860000.0
             :requires-eg-entity? true :has-eg-entity? true
             ...
             :drafted? false :submitted? false
             :jurisdiction "EGY" :status :intake}
    "eng-6" {:id "eng-6" :operator "Chuo Civic Tech" :portal "e-Tenders"
...
(defn- engagement->tx [{:keys [id operator portal base-fee monthly-rate monitoring-months claimed-fee
                               requires-eg-entity? has-eg-entity?
  ...
  (cond-> {:engagement/id id}
    ...
    (some? requires-eg-entity?)  (assoc :engagement/requires-eg-entity? requires-eg-entity?)
    (some? has-eg-entity?)       (assoc :engagement/has-eg-entity? has-eg-entity?)
...
(def ^:private engagement-pull
  [:engagement/id :engagement/operator :engagement/portal :engagement/base-fee :engagement/monthly-rate
   ...
   :engagement/requires-eg-entity? :engagement/has-eg-entity?
...
(defn- pull->engagement [m]
  (when (:engagement/id m)
    {:id (:engagement/id m) :operator (:engagement/operator m) :portal (:engagement/portal m)
     ...
     :requires-eg-entity? (boolean (:engagement/requires-eg-entity? m))
     :has-eg-entity? (boolean (:engagement/has-eg-entity? m))
...
(defn kotobase-store
  ...
  [{:keys [db-api seq-fn]}]
  (->KotobaseStore (persist/store {:db-api db-api :actor "marketentry-egy"})

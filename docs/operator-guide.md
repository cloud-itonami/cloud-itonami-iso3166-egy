...
2. Register the client's intake: business type, target public function,
   prior filing history in Egypt if any.
3. Run the advisor in read-only mode against the Unified Public
   Procurement Law (Law No. 182/2018) tender-publication requirements and
   Egypt's Government Procurement Portal.
4. Compare the checklist against the client's current documentation
   (GAFI company-registry entry, ETA tax registration).
...
- named referral relationship with Egyptian-licensed counsel or a
...
a working referral relationship with Egyptian-licensed counsel or a
registered agent for whatever licensed representation the law of
Egypt requires for actual public-procurement filings.

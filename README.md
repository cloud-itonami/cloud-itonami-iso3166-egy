# cloud-itonami-iso3166-egy

Open ISO 3166 Blueprint for **EGY**: Egypt.
...
tax registration, and local-content rules in Egypt, so the operator
...
- **Not the government of Egypt.** See
...
- **Not legal or tax advice.** Every regulatory claim must cite the
  official source and route final filings to Egyptian-licensed counsel
...
(ISO 3166 `EGY`). Required capabilities:
